    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.transparent,
          elevation: 0,
          title:  Text('Playlist', style: GoogleFonts.poppins(fontSize: 30,color: Colors.black , fontWeight: FontWeight.bold ),),
        ),
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return ListTile(
          ...
          subtitle: Text('${playlist.songs![index].description} ', style: GoogleFonts.poppins(color: Colors.white),),
          trailing: const Icon(
            Icons.more_vert,
            color: Colors.white,
          ),
